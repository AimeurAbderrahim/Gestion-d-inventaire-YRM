// TODO: handle this class later 
// NOTE: i commented this code just to test 
// /**
...
//  *		    EmplacementDatabase emplacementDB = new EmplacementDatabase();
//  *		    
...
// 	}
// 
// 	// TODO: create class in utils package to handle this convert enumeration
// 
// 	@Override
...
// 		return "id_emplacement = ?, type_salle = ?, superficie = ?, bureau = ? ";
// 	}
// 
// 	@Override
...
// 		emplacement.setService(result.getString("nom_service"));
// 		return emplacement;
// 	}
// 
// 	@Override
