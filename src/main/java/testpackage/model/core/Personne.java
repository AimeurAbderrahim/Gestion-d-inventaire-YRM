...
public class Personne {
	...
	public Personne(String nom, String prenom, LocalDate date_naissance_P, String adresse, String email, String numero_tel_personne, boolean hasAccount , String id_emplacement , String id_c) throws NotNullException {
		if(
	...
	public void setAccountValueBool(boolean value){
